        ...
        return (
            <div className = "LoginPage LoginBlockTermsOfUse">
                ...
                <p className = "LoginBlockParagraph">
                    These terms and conditions («Terms», «Agreement») are an agreement between Mobile Application Developer («Mobile Application Developer», «us», «we» or «our») and you («User», «you» or «your»). This Agreement sets forth the general terms and conditions of your use of the mobile application and any of its products or services (collectively, «Mobile Application» or «Services»).
                </p>
                <h3 className = "LoginBlockOffHeading">Accounts and membership</h3>
                <p className = "LoginBlockParagraph">
                ...
                <h3 className = "LoginBlockOffHeading">User content</h3>
                <p className = "LoginBlockParagraph">
...
const containerTermsOfUse = connect(
    mapStateToProps,
    mapDispatchToProps
  )(TermsOfUse);

export default containerTermsOfUse;